...
public class Tietovarasto {
    ...
    */
    ...
    private static void lisaaKaavat(Kaavamuistio kaavamuistio, String hakemistonNimi) {
        try {
            Scanner lukija = new Scanner(new FileReader(hakemistonNimi+"\\listaus.txt"));
    ...
    private static Kaava lueKaava(String hakemistonNimi, String kaavanTunniste) {
        try {
            Scanner lukija = new Scanner(new FileReader(hakemistonNimi+"\\"+kaavanTunniste+"\\kaava.txt"));
            String nimi = "", lauseke = "";
    ...
    private static Laskentahistoria lueLaskentahistoria(String hakemistonNimi, String kaavanTunniste) {
        try {
            Scanner lukija = new Scanner(new FileReader(hakemistonNimi+"\\"+kaavanTunniste+"\\historia.txt"));
    ...
    */
    ...
    private static void tallennaKaava(Kaava kaava, String hakemistonNimi, String kaavanTunniste) {
        try {
            ...
            printWriter.println(kaava.getLaskentahistoria().kaikkiRivit());
            printWriter.close();
        } catch (FileNotFoundException | UnsupportedEncodingException e) {}
    }
}
